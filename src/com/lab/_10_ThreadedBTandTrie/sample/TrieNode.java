 ...
 * adopted from https://community.oracle.com/thread/2070706
 */
...
public class TrieNode {
    ...
    protected void addWord(String word) {
        //insert code checking if word is empty and throw an IndexOutofBoundsException
        //also add code to check for invalid characters and throw an IllegalArgumentException
